...
<div class="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
    ...
    <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
        ...
        <p class="mt-5 text-center text-sm text-gray-500">Already have an account?
            <a href="{{route('loginpage')}}" class="font-semibold leading-6 text-indigo-600 hover:text-indigo-500">Log in</a>
        </p>
